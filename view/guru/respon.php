							...
							<div class="col-md-12 tombol">
								<div class="input-group">
							     	<span class="input-group-btn">
							    		<button class="btn btn-primary btn-sm sharp" type="button" id="buttonGenerateSoal" value="input_soal" name="input_soal" ng-click="generateResponForm()">Generate</button>
							    	</span>
							    </div>
							</div>
						</div>
					...
					<div class="col-md-12 soal" id="inputSoal">
						...
						<div id="btn_inputSoal">
							...
							<div class="col-md-1 tombol">
								<div class="input-group">
									<span class="input-group-btn">
										<input class="btn btn-primary btn-sm sharp" type="submit" id="buttonInputSoal" value="Submit Response" name="lihat_soal" ng-click="pushRespon()">Submit Response</input>
									</span>
								</div>
							</div>
						</div>	
